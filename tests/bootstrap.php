...
function home_url( $p = '' ) { return 'https://staging.klant.nl' . $p; }
function site_url( $p = '' ) { return 'https://staging.klant.nl' . $p; }
function network_home_url( $p = '' ) { return 'https://staging.klant.nl' . $p; }
